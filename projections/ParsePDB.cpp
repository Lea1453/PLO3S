...
int vidock_User_Inputs(int argc, char** argv)
{
	/*ParsePDB pp;
	//ProteinSurface pps;
	int inum[4];
	...
	inname = "1brs";
	//to be introduced MS, VCMC, MC 
	tpname = "1brs_out";
	 
	
	// modifiy this CD: 28 Oct 2015 
	
	// automatic pdb file loading and default option
	// output = input_out
       if(argc<3)
	{
	...
	bcolor=true;
	//okpp.loadpdb(inname);
	//okpp.extractbb(0,-1,1);
//	pp.PCA();
	//okpps.proberadius=fnum[0];
	//ojpps.fixsf=fnum[1];
	remcstart=clock(); 
	if(inum[1]==1)
	{
